...
{}, 
'datasets/bdd100k/day_train.json', 
'datasets/bdd100k/day_train')

register_coco_instances("bdd100k_night_train", 
{}, 
'datasets/bdd100k/night_train.json'
, 
'datasets/bdd100k/night_train')
register_coco_instances("bdd100k_night_val", 
{}, 
'datasets/bdd100k/night_val.json', 
'datasets/bdd100k/night_val')

# ====================
register_coco_instances("bdd100k_day_train_cs",
{}, 
'datasets/bdd100k/cs2bdd_day_train.json', 
'datasets/bdd100k/day_train')

register_coco_instances("bdd100k_day_val_cs", 
{}, 
'datasets/bdd100k/cs2bdd_day_val.json', 
'datasets/bdd100k/day_val')

#=====================
register_coco_instances("cityscapes_coco_train",
{}, 
'datasets/cityscapes/annotations/train_7.json', 
'datasets/cityscapes')
register_coco_instances("cityscapes_coco_val", 
{}, 
'datasets/cityscapes/annotations/val_7.json', 
'datasets/cityscapes')
